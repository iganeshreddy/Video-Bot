...
# Configuration
FLIC_TOKEN = "flic_23d898babb6e0b4de8931850277921ca5db8396e670ba7e2061cd0aedf4c867d"  # Replace with your Flic-Token
CATEGORY_ID = 25  # Replace with the appropriate category ID
VIDEO_PATH = Path("./videos")  # Directory to monitor for new .mp4 files
VIDEO_URLS = ["https://www.instagram.com/p/CdySxNqjqmP/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA=="]  # Add Instagram/TikTok URLs here
